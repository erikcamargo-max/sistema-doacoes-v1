...
function setupEventListeners() {
    ...
    // Botão Salvar Doação
    const btnSaveNew = document.getElementById('btn-save-donation');
    if (btnSaveNew) {
        ...
        console.log('✅ Event listener botão Salvar configurado');
    } else {
        console.log('⚠️ Botão btn-save-donation não encontrado no HTML');
    }
    ...
    if (btnCloseModal) {
        btnCloseModal.addEventListener('click', function(e) {
            ...
            if (typeof closeModal === 'function') {
                ...
                console.error('❌ Função closeModal não encontrada');
            }
        });
        console.log('✅ Event listener botão Fechar configurado');
    } else {
        console.log('⚠️ Botão btn-close-modal não encontrado no HTML');
    }
    ...
    console.log('✅ Event listener ESC para fechar modal configurado');
} else {
...
// ===============================================================================
// FUNÇÃO PARA ADICIONAR NOVA DOAÇÃO - Versão 1.1.5
// ===============================================================================

/**
 * Adiciona nova doação do modal
