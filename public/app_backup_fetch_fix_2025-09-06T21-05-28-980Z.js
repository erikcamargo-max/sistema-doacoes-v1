...
//         const response = await fetch('/api/doacoes', { (await removido - era ilegal)
            method: 'POST',
//             headers: { (linha incompleta removida)
...
function validateFormData(data) {
    ...
    // return (removido - era ilegal) { isValid: true };
}
...
function formatDate(dateString) {
    ...
    try {
        ...
        // return (removido - era ilegal) date.toLocaleDateString('pt-BR');
    } catch (error) {
        // return (removido - era ilegal) dateString;
    }
}
...
<body>
    ...
    <script>
        function formatarCPF(cpf) {
            // return (removido - era ilegal) cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4');
        }
        ...
        function gerarParcelasHTML(doacao, historico) {
            ...
            // return (removido - era ilegal) html;
        }
        ...
        function calcularVencimento(dataInicial, meses) {
            ...
            // return (removido - era ilegal) data.toISOString().substring(0, 10);
        }
        ...
        function buscarPagamento(historico, dataVenc) {
            ...
            // return (removido - era ilegal) null;
        }
    </script>
</body>
</html>`;
...
function criarCSV(doacoes) {
    ...
    // return (removido - era ilegal) '\uFEFF' + rows.join('\n');
}
